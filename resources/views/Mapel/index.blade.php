  ...
  <section class="content-header">
                         ...
                         <form action="{{ route('mapel.store') }}" method="POST">
                            @csrf
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="kode_mapel" name="kode_mapel" aria-describedby="emailHelp">
                                    </div>
                                  <div class="form-group">
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <th width="280px" class="text-center">Kode Mapel</th>
            <th width="280px" class="text-center">Mata Pelajaran</th>
            <th width="280px" class="text-center">Guru Mapel</th>
        ...
        <tr>
            ...
            <td width="280x">{{ $data->kode_mapel }}</div></td>
            <td width="280px">{{ $data->nama_mapel }}</div></td>
            ...
            <td width="100px">
                  ...
                  <div class="modal fade" id="modalshow{{ $data->id }}" tabindex="-1" aria-labelledby="modalTambahmhs1" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                                <h5 class="modal-title">Detail Data Mata Pelajaran</h5>
                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                      </button>
                          </div>
                          ...
                          <div class="modal-body">
                                <form action="{{ route('mapel.update',$data->id) }}" method="POST">
                                  ...
                                  @method('put')
                                        <div class="form-group">
                                          <label for="">Kode Mapel</label>
                                          <input type="text" class="form-control" id="kode_mapel" name="kode_mapel" aria-describedby="emailHelp" value="{{ $data->kode_mapel }}">
                                          </div>
                                        <div class="form-group">
