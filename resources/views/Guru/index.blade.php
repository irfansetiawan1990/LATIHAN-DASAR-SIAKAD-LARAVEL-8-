  ...
  <section class="content-header">
    ...
    <section class="content">
      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <!-- Modal -->
             <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalTambahmhs">Tambah</button>
                          ...
                          <form action="{{ route('guru.store') }}" method="POST">
                            @csrf
                                  <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_guru" name="nama_guru" aria-describedby="emailHelp">
                                    </div>
    ...
    <table class="table table-bordered">
        <tr>
            ...
            <th width="280px" class="text-center">Nama Guru</th>
        ...
        <tr>
            ...
            <td width="280x">{{ $data->nama_guru }}</div></td>
            <td width="280x">{{ $data->nip }}</div></td>
            <td width="100px">
                                ...
                                <form action="{{ route('guru.update',$data->id) }}" method="POST">
                                  ...
                                  @method('put')
                                        <div class="form-group">
                                          ...
                                          <input type="text" class="form-control" id="nama_guru" name="nama_guru" aria-describedby="emailHelp" value="{{ $data->nama_guru }}">
                                          </div>

                                          <div class="form-group">
                                          <label for="">NIP</label>
                                          <input type="text" class="form-control" id="nip" name="nip" aria-describedby="emailHelp" value="{{ $data->nip }}">
                                          </div>
                                <button type="submit" class="btn btn-primary">Simpan Data</button>
                                </form>
